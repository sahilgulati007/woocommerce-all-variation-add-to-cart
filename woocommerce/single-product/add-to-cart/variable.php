		...
		<table class="variations" cellspacing="0">
			<tbody>
				...
				foreach ( $attributes as $attribute_name => $options ) :
					$loop++;
					$p=(array)$product;
					$cvar=$product->get_available_variations();
					if($attribute_name=='pa_qty'){
                                   // echo "<pre>";
                                   // print_r($attributes);
                                   // print_r($options);
                                   ...
                                   // echo "</pre>";
                                    ...
                                    echo "<tr><td >Pack Size</td><td>Price</td><td>Quantity</td></tr>";
                                    $i=0;
                                    foreach($options as $o){
                                    	if($i==10000){
                                        echo "<tr><td style='float: left;width: 49%;text-transform: uppercase;'>".$o." </td><td>".$cvar[$i]['price_html']."</td> <td style='float: left;width: 49%'>Qty:<input type='number' size='2' name='qty' data-attr='".$o."' value='0' style='width:4.25em'></td><td rowspan=".sizeof($options)."><a id='buyp' href='#'' style='font: bold 11px Arial; text-decoration: none; border-top: 1px solid #CCCCCC; border-right: 1px solid #333333; border-bottom: 1px solid #333333; border-left: 1px solid #CCCCCC; background-color: #333333; border-color: #333333; padding: 10px; color: #ffffff;'>Add To Cart</a></td></tr>";
                                    }
                                    else{
                                    	echo "<tr><td>".$o." </td><td>".$cvar[$i]['price_html']."</td> <td>Qty:<input type='number' size='2' name='qty' data-attr='".$o."' value='0' style='width:4.25em'></td></tr>";
                                    }
                                    $i++;
                                    }
                                    echo "</table>";
